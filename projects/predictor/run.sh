...
bash scripts/train.sh projects/predictor/train.py $dev --seqname $seqname --logname $logname --num_rounds 40 --imgs_per_gpu 128 --iters_per_round 50 --poly_1 $folder_path --poly_2 $folder_path --${inside_out}inside_out
...
bash scripts/train.sh projects/predictor/train.py $dev --seqname $seqname --logname $logname-ft1 --num_rounds 40 --imgs_per_gpu 128 --iters_per_round 50 \
    --load_path logdir/$seqname-$logname/ckpt_latest.pth --poly_1 $folder_path --poly_2 $folder_path --${inside_out}inside_out
...
bash scripts/train.sh projects/predictor/train.py $dev --seqname $seqname --logname $logname-ft2 --num_rounds 40 --imgs_per_gpu 128 --iters_per_round 50 \
    --load_path logdir/$seqname-$logname-ft1/ckpt_latest.pth --poly_1 $folder_path --poly_2 $folder_path --${inside_out}inside_out
...
bash scripts/train.sh projects/predictor/train.py $dev --seqname $seqname --logname $logname-ft3 --num_rounds 40 --imgs_per_gpu 128 --iters_per_round 50 \
    --load_path logdir/$seqname-$logname-ft2/ckpt_latest.pth --poly_1 $folder_path --poly_2 $folder_path --${inside_out}inside_out
...
bash scripts/train.sh projects/predictor/train.py $dev --seqname $seqname --logname $logname-ft4 --num_rounds 40 --imgs_per_gpu 128 --iters_per_round 50 \
    --load_path logdir/$seqname-$logname-ft3/ckpt_latest.pth --poly_1 $folder_path --poly_2 $folder_path --${inside_out}inside_out