...
parser.add_argument("--outdir", default="eagle", help="output dir")
...
parser.add_argument("--nframes", default=3, type=int, help="number of frames to render")
parser.add_argument(
...
#                 "database/eagle/Eagle-original_%06d.obj" % int(i * args.xspeed),
#                 load_texture=True,
#                 texture_res=5,
...
#             mesh = sr.Mesh.from_obj(
#                 "database/hands/hands_%06d.obj" % int(1 + i * args.xspeed),
#                 load_texture=True,
#                 texture_res=100,
#                 texture_type="surface",
#             )
...
#         cv2.imwrite(
#             "%s/DAVIS/JPEGImages/Full-Resolution/%s/%05d.jpg"
#             % (filedir, args.outdir, i),
#             rendered_img[:, :, ::-1],
#         )
#         cv2.imwrite(
#             "%s/DAVIS/Annotations/Full-Resolution/%s/%05d.png"
#             % (filedir, args.outdir, i),
#             rendered_sil,
#         )
#         np.savetxt(
#             "%s/DAVIS/Cameras/Full-Resolution/%s/%05d.txt" % (filedir, args.outdir, i),
#             rtk,
#         )
#         mesh_cam.export(
#             "%s/DAVIS/Meshes/Full-Resolution/%s/%05d.obj" % (filedir, args.outdir, i)
#         )
#         print(i)
...
#             flobw_outdir = "%s/DAVIS/FlowBW_%d/Full-Resolution/%s/" % (
#                 filedir,
#                 dframe,
#                 args.outdir,
#             )
#             flofw_outdir = "%s/DAVIS/FlowFW_%d/Full-Resolution/%s/" % (
#                 filedir,
#                 dframe,
#                 args.outdir,
#             )
...
#                 cv2.imwrite(
#                     "%s/col-%05d.jpg" % (flofw_outdir, i - dframe),
#                     flow_to_image(flow_fw)[:, :, ::-1],
#                 )
#                 cv2.imwrite(
#                     "%s/col-%05d.jpg" % (flobw_outdir, i),
