...
bash projects/csim/recon_compose_multi.sh $seqname $fg_motion $dev # cat, with shape
# bash projects/csim/recon_compose_multi_fs.sh $seqname $fg_motion $dev # dog, bunny
