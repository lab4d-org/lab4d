...
bash scripts/train.sh lab4d/train.py $dev --seqname $seqname --logname $logname \
  --fg_motion $fg_motion --num_rounds 20 --feature_type cse --intrinsics_type const --imgs_per_gpu 128 --init_scale_fg 0.1 --extrinsics_type mlp_nodelta --reg_l2_motion_wt 0.1
