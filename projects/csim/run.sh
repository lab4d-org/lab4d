...
bash scripts/train.sh lab4d/train.py $dev --seqname $seqname --logname $logname --field_type bg --field_type comp --fg_motion urdf-quad \
  --intrinsics_type const --extrinsics_type mix --feature_channels 384 \
  --freeze_scale --freeze_field_fgbg --freeze_camera_bg --freeze_camera_fg --learning_rate 1e-4 --load_path logdir/$vidname-fg-urdf/ckpt_latest.pth  --load_path_bg logdir/home-$vidname-bg-adapt3/ckpt_latest.pth --noreset_steps --noabsorb_base --nouse_freq_anneal --num_rounds 20 \
...
# # # compose
# # seqname=home-cat-pikachu-6
# # logname=ppr-dino
# # rm -rf logdir/$seqname-$logname
# # bash scripts/train.sh projects/ppr/train.py 0 --seqname $seqname --logname $logname --field_type comp --data_prefix full --fg_motion urdf-quad \
# #   --pixels_per_image 12 --iters_per_round 100 --secs_per_wdw 2.4 --noreset_steps  --noabsorb_base --phys_vid 1 \
# #   --intrinsics_type mix --extrinsics_type mix --feature_channels 384 \
# #   --freeze_scale --learning_rate 1e-4 --load_path logdir/cat-pikachu-6-fg-urdf-dino-fixintr/ckpt_latest.pth --load_path_bg logdir/home-cat-pikachu-6-bg-cate-adapt3/ckpt_latest.pth --nouse_freq_anneal --num_rounds 20 \
