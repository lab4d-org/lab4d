...
bash scripts/train.sh lab4d/train.py $dev --seqname $seqname --logname $logname --fg_motion urdf-quad --feature_type cse --intrinsics_type const --num_rounds 120 --depth_wt 1e-3 \
